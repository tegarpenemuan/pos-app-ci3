    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('customer') ?>" class="btn btn-danger btn-flat"><i class="fa fa-undo"></i> Back</a>
            </div>
        </div>
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <form action="<?= site_url('customer/process') ?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_name" class="form-control" id="customer_name" value="<?= $row->name ?>" autocomplete="off" required>
                        </div>
                        <div class="form-group">
